...
*@viewId:icd.discreteindustries.managecontrolcycles::sap.suite.ui.generic.template.ListReport.view.ListReport::C_JITControlCycleTP
*/
sap.ui.define([
    ...
    function (
        ...
        "use strict";
        return ControllerExtension.extend("jitcontrolcycles1.CustomAllBtn", {
            // metadata: {
            ...
            // 	 * @memberOf jitcontrolcycles1.CustomAllBtn
            // 	 */
            // 	onInit: function() {
            // 	},
